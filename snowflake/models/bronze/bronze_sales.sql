...
GRANT INSERT ON TABLE BRONZE_SALES TO ROLE RAW_ROLE;            -- Kafka streaming user needs INSERT privilege
...
snowflake.topic2table.map = sales_transactions_topic:BRONZE_SALES

-- DLQ / Error Handling (handled connector-side):
errors.tolerance = all
errors.deadletterqueue.topic.name = sales_transactions_dlq
